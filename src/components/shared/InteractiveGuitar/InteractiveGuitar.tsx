...
// ──────────────────────────────────────────────
// InteractiveGuitar — shared SVG component
// ──────────────────────────────────────────────
// Pure SVG illustration of an acoustic/electric
// guitar used in the BeyondTech section.
//
// All measurements are relative to the 100x200
// viewBox — scales automatically.
// No interactivity — just visual.
// ──────────────────────────────────────────────
...
export default function InteractiveGuitar() {
  ...
  // X-positions for the 6 strings (evenly spaced)
